...
typedef enum { IND_MEAS_IDLE = 0, IND_MEAS_REST, IND_MEAS_PULSE, IND_MEAS_DONE, IND_MEAS_FAULT } ind_meas_state_t;

typedef enum { IND_MEAS_AXIS_D = 0, IND_MEAS_AXIS_Q } ind_meas_axis_t;

typedef enum { IND_MEAS_FAULT_NONE = 0, IND_MEAS_FAULT_BAD_CONFIG, IND_MEAS_FAULT_OVER_CURRENT, IND_MEAS_FAULT_NO_VALID_SAMPLE } ind_meas_fault_t;
