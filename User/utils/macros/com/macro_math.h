...
#define _shift_left(arg, shiftAmount) (shiftAmount > 0 ? arg << shiftAmount : arg >> (-shiftAmount))

#define _shift_right(arg, shiftAmount) (shiftAmount > 0 ? arg >> shiftAmount : arg << (-shiftAmount))
