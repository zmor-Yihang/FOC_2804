...
void as5600_test_init(void) {
    ...
    printf("as5600 step scan start: points=%u pole_pairs=%u voltage=%.3fV\r\n", AS5600_TEST_MECH_SCAN_POINTS, MOTOR_POLE_PAIRS, (double)AS5600_TEST_ALIGN_VOLTAGE);
}
...
void as5600_test_poll(void) {
    ...
    printf("as5600 step=%u raw=%u cmd=%.6f meas=%.6f err=%.6f err_deg=%.3f\r\n", as5600_test_step_idx, raw_count, (double)as5600_test_cmd_mech_rad, (double)meas_mech_rad, (double)err_avg_rad,
    ...
    if (as5600_test_step_idx >= AS5600_TEST_MECH_SCAN_POINTS) {
        ...
        printf("as5600 scan done: err[min=%.6f max=%.6f pp=%.6f abs_max=%.6f] rad, pp_deg=%.3f\r\n", (double)as5600_test_err_min, (double)as5600_test_err_max,
               (double)(as5600_test_err_max - as5600_test_err_min), (double)as5600_test_err_abs_max, (double)((as5600_test_err_max - as5600_test_err_min) * 180.0f / MATH_PI));
        return;
    }
